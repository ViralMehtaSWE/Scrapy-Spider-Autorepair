...
Report bugs at https://github.com/virmht/Scrapy-Spider-Autorepair/issues
...
The best way to send feedback is to file an issue at https://github.com/virmht/Scrapy-Spider-Autorepair/issues.
...
1. Fork the `Scrapy-Spider-Autorepair` repo on GitHub.
2. Clone your fork locally::

  .. code-block:: bash

    $ cd path_for_the_repo
    $ git clone git@github.com:virmht/Scrapy-Spider-Autorepair.git
